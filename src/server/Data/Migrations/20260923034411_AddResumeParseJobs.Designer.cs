...
namespace MyThorneAI.Ats.Api.Data.Migrations
{
    ...
    [Migration("20260923034411_AddResumeParseJobs")]
    partial class AddResumeParseJobs
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MyThorneAI.Ats.Api.Domain.Candidate", b =>
                {
                    ...
                    b.PrimitiveCollection<string[]>("ResumeCertifications")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<string[]>("ResumeEducation")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<string[]>("ResumeJobTitles")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.PrimitiveCollection<string[]>("ResumeLanguages")
                        .IsRequired()
                        .HasColumnType("text[]");

                    b.Property<DateTimeOffset?>("ResumeParsedAt")
                        .HasColumnType("timestamp with time zone");

                    b.PrimitiveCollection<string[]>("ResumeSkills")
                        .IsRequired()
                        .HasColumnType("text[]");
                    ...
                    b.Property<decimal?>("ResumeYearsExperience")
            ...
            modelBuilder.Entity("MyThorneAI.Ats.Api.Domain.Interview", b =>
                {
                    ...
                    b.Property<string>("MeetingNotesSource")
                        .HasMaxLength(120)
                        .HasColumnType("character varying(120)");

                    b.Property<DateTimeOffset?>("MeetingNotesUpdatedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("MyThorneAI.Ats.Api.Domain.ResumeParseJob", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
